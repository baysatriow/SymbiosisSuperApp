    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            window.showToast = function(message, type = 'info') {
                ...
                const toastHtml = `
                    <div class="toast-enter flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow border border-gray-200" role="alert">
            ...
            @if($errors->any()) showToast("Periksa kembali input Anda.", 'error'); @endif
        });
    </script>
</body>
</html>
